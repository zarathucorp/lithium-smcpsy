...
# 3409 : a[!is.na(totDay_Valproate),.N,]
# 189 : a[LithiumToxicity!=0,.N,]
# 951 : a[!is.na(totDay_Lithium),.N,]
...
ggsurvplot(
    ...
    legend.labs = c("Lithium", "Valproate"),    # Change legend labels
...
ggplot(b,aes(x=cumulativePrescriptionDay,y=eGFR))+
